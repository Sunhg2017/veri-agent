...
- **文件**: 
  ...
  - `asset/application/AssetService.java`（当前约 865 行，版本历史/版本回滚/生命周期/需求资产/影响分析/导入导出/原型同步/追踪关系/测试用例步骤/项目审计上下文/响应 DTO 映射职责已拆出）
