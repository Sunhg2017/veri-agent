...
- **文件**: 
  ...
  - `management/infrastructure/InMemoryManagementConsoleService.java`（当前约 792 行，local profile 部门、用户、项目、应用、环境、集成、配置和密钥引用职责已拆出）
