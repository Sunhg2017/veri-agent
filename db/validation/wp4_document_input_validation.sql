...
with expected(table_name, column_name) as (
    values
        ...
        ('document_input_parse_feedback_sample','project_id'), ('document_input_parse_feedback_sample','source_type'), ('document_input_parse_feedback_sample','input_digest'),
        ('document_input_parse_feedback_sample','source_ref_digest'), ('document_input_parse_feedback_sample','source_fragment_digest'),
        ('document_input_parse_feedback_sample','parse_source'), ('document_input_parse_feedback_sample','model_invocation_id'),
        ('document_input_parse_feedback_sample','model_provider_name'), ('document_input_parse_feedback_sample','model_name'),
        ('document_input_parse_feedback_sample','correction_type'), ('document_input_parse_feedback_sample','changed_fields'),
        ('document_input_parse_feedback_sample','before_snapshot_json'), ('document_input_parse_feedback_sample','after_snapshot_json'),
        ('document_input_parse_feedback_sample','curation_status'), ('document_input_parse_feedback_sample','created_by'),
        ('document_input_parse_feedback_sample','created_at'), ('document_input_parse_feedback_sample','updated_at'),
        ('document_input_parse_feedback_sample','deleted_at'), ('document_input_parse_feedback_sample','version'),
...
with expected(table_name, index_name) as (
    values
        ...
        ('document_input_parse_feedback_sample','idx_document_input_parse_feedback_import'),
        ('document_input_parse_feedback_sample','idx_document_input_parse_feedback_invocation'),
...
with expected(constraint_name) as (
    values
        ...
        ('ck_document_input_parse_feedback_source_type'),
        ('ck_document_input_parse_feedback_parse_source'),
        ('ck_document_input_parse_feedback_correction_type'),
        ('ck_document_input_parse_feedback_curation_status'),
        ('ck_document_input_parse_feedback_changed_fields'),
