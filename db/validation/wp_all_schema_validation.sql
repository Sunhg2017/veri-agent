...
with expected(table_name, column_name) as (
    values
        ...
        ('api_automation_run','id'), ('api_automation_run','project_id'),
        ('api_automation_run','bundle_id'), ('api_automation_run','environment_id'),
        ('api_automation_run','base_url_digest'), ('api_automation_run','base_url_host'),
        ('api_automation_run','status'), ('api_automation_run','timeout_seconds'),
        ('api_automation_run','case_count'), ('api_automation_run','trace_id'),
        ('api_automation_run','runner_mode'), ('api_automation_run','external_run_id'),
        ('api_automation_run','error_code'), ('api_automation_run','error_summary'),
        ('api_automation_run','started_at'), ('api_automation_run','completed_at'),
        -- WP7 key columns
        ('ui_e2e_scene','id'), ('ui_e2e_scene','project_id'),
        ('ui_e2e_scene','application_id'), ('ui_e2e_scene','environment_id'),
        ('ui_e2e_scene','code'), ('ui_e2e_scene','name'),
        ('ui_e2e_scene','status'), ('ui_e2e_scene','risk_level'),
        ('ui_e2e_scene','source_summary_json'), ('ui_e2e_scene','tags_json'),
        ('ui_e2e_scene','archived_at'),
        ('ui_e2e_scene_step','id'), ('ui_e2e_scene_step','scene_id'),
        ('ui_e2e_scene_step','project_id'), ('ui_e2e_scene_step','step_order'),
        ('ui_e2e_scene_step','step_type'), ('ui_e2e_scene_step','action_summary_json'),
        ...
        ('ui_e2e_bundle_review','id'), ('ui_e2e_bundle_review','bundle_id'),
        ...
        ('ui_e2e_run','id'), ('ui_e2e_run','scene_id'),
        ('ui_e2e_run','bundle_id'), ('ui_e2e_run','project_id'),
        ('ui_e2e_run','status'), ('ui_e2e_run','request_key'),
        ('ui_e2e_run','runner_mode'), ('ui_e2e_run','base_url_digest'),
        ('ui_e2e_run','account_lease_ref'),
        ('ui_e2e_run','account_summary_json'),
        ('ui_e2e_run','failure_code'), ('ui_e2e_run','failure_summary'),
        ('ui_e2e_run','trace_id'), ('ui_e2e_run','started_at'),
        ...
        ('ui_e2e_flaky_mark','id'), ('ui_e2e_flaky_mark','project_id'),
        ('ui_e2e_flaky_mark','scene_id'), ('ui_e2e_flaky_mark','run_id'),
