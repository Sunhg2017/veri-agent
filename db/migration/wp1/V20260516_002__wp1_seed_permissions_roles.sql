...
with role_permissions(role_code, permission_code) as (
    ...
    ('SuperAdmin','department:read'),('SuperAdmin','department:create'),('SuperAdmin','department:edit'),('SuperAdmin','department:enable'),('SuperAdmin','department:disable'),('SuperAdmin','department:member_manage'),
    ('SuperAdmin','user:read'),('SuperAdmin','user:create'),('SuperAdmin','user:edit'),('SuperAdmin','user:enable'),('SuperAdmin','user:disable'),('SuperAdmin','user:lock'),('SuperAdmin','user:assign_role'),
    ('SuperAdmin','project:read'),('SuperAdmin','project:create'),('SuperAdmin','project:edit'),('SuperAdmin','project:archive'),('SuperAdmin','project:disable'),('SuperAdmin','project:member_manage'),
    ('SuperAdmin','application:read'),('SuperAdmin','application:create'),('SuperAdmin','application:edit'),('SuperAdmin','application:disable'),
    ('SuperAdmin','environment:read'),('SuperAdmin','environment:create'),('SuperAdmin','environment:edit'),('SuperAdmin','environment:disable'),('SuperAdmin','environment:use'),('SuperAdmin','config:read'),('SuperAdmin','config:edit'),
