...
| 响应式主链路 | 桌面和 390px 窄屏均可完成导入、diff、sync、生成、评审、运行、取消和导出，页面无横向整体溢出 |
