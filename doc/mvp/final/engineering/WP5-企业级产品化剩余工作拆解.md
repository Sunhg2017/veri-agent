...
| P1 | 前端产品化 | 前端工程师 | 已补任务筛选、候选筛选、勾选候选发布、冲突摘要和发布结果跳转 WP3 资产追踪；仍需字段级质量提示、批量编辑和更完整分页。 | 用户无需 curl 可完成主链路；移动/窄屏无重叠。 |
...
| M4 前端企业化 | 用户在页面完成主流程 | 任务工作台、候选评审、发布预览、错误态 | 前端工程师 | 已具备任务/候选筛选、选择性发布、冲突摘要和 WP3 跳转；仍需字段级质量提示和分页效率优化。 |
