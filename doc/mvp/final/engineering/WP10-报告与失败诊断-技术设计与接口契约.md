...
| `GET` | `/{id}` | `report:read` | M3A 已实现。查询报告详情并返回 WP9 节点级 evidence manifest；WP8/WP3/WP5 证据、诊断和草稿仍返回空结构或 `NOT_REQUESTED`。 |
