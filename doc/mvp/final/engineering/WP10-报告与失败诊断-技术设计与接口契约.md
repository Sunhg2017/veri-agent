...
| 当前口径 | 当前范围已推进至 M9：`platform-api` 已新增 `reporting` 模块，消费 WP9/WP8/WP3/WP5 脱敏摘要，通过 WP2 受控模型调用生成诊断建议，并提供缺陷草稿、JSON/Markdown 脱敏导出和 quality gate |
| 版本 | v0.2 |
| 日期 | 2026-06-17 |
...
| `GET` | `/{id}` | `report:read` | M9 已实现。查询报告详情并返回 WP9/WP8/WP3/WP5 evidence manifest、最新诊断和缺陷草稿摘要。 |
