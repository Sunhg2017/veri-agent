...
| WP5-6.3 | P0 | `scripts/wp5_quality_gate.sh` | 串联后端测试、前端测试、构建、DB validation 和可选 smoke。 |
...
| M4 MVP 准出 | 文档、代码、脚本和验收材料齐备 | quality gate、smoke、AI 质量评测、发布准出记录 | 默认验证和 WP5 专项验证全部通过或有明确风险豁免。 |
