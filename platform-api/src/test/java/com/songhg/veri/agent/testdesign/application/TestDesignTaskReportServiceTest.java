...
class TestDesignTaskReportServiceTest {
    ...
    void appendsReportManifestPolicyRowsWithoutRowOrIdentifierDetails() {
        ...
        org.assertj.core.api.Assertions.assertThat(report)
                ...
                .contains("reportManifestPolicy,rowIntegrityStored,,true,,success")
                .contains("reportManifestPolicy,rowIntegrityIndexReady,,true,,success")
    ...
    void appendsBoundedArchivePolicyRowsWithoutFreeText() {
        ...
        org.assertj.core.api.Assertions.assertThat(report)
                ...
                .contains("archivePolicy,archiveApprovalWorkflowReady,,true,,success")
                .contains("archivePolicy,externalShareApprovalWorkflowReady,,true,,success")
                .contains("archivePolicy,workOrderWorkflowReady,,true,,success")
                .contains("archivePolicy,externalSharingAllowed,,true")
                .contains("archivePolicy,retentionPolicyTracked,,true,,success")
                .contains("archivePolicy,archiveStorageReady,,true,,success")
                .contains("archivePolicy,archiveContentStored,,true,,success")
                .contains("archivePolicy,lineIntegrityIndexReady,,true,,success")
                .contains("archivePolicy,archiveContentExported,,false")
    ...
    void appendsPromptCalibrationPolicyRowsWithoutSampleDetails() {
        ...
        org.assertj.core.api.Assertions.assertThat(report)
                ...
                .contains("promptCalibrationPolicy,sampleSource,,MAINTAINED_GOLDEN_SET_WITH_HUMAN_FEEDBACK")
                .contains("promptCalibrationPolicy,calibrationStatus,,BASELINE_RUN_HISTORY_READY")
                ...
                .contains("promptCalibrationPolicy,sampleSetMaintenanceWorkflowReady,,true,,success")
                .contains("promptCalibrationPolicy,longTermCalibrationBaselineReady,,true,,success")
    ...
    void appendsScopePolicyRowsWithoutRoleOrTokenDetails() {
        ...
        org.assertj.core.api.Assertions.assertThat(report)
                ...
                .contains("scopePolicy,evaluationCorpusOperationsReady,,true,,success")
                .contains("scopePolicy,crossWpScopeDashboardReady,,true,,success")
    ...
    void appendsEvaluationCorpusPolicyRowsWithoutSampleOrPromptDetails() {
        ...
        org.assertj.core.api.Assertions.assertThat(report)
                ...
                .contains("evaluationCorpusPolicy,sampleMaintenanceReady,,true,,success")
                .contains("evaluationCorpusPolicy,longTermCalibrationReady,,true,,success")
                .contains("evaluationCorpusPolicy,operationsConsoleReady,,true,,success")
    ...
    void appendsReleaseReadinessPolicyRowsWithoutApprovalOrCandidateEvidence() {
        ...
        org.assertj.core.api.Assertions.assertThat(report)
                ...
                .contains("releaseReadinessPolicy,approvalWorkflowReady,,true,,success")
                ...
                .contains("releaseReadinessPolicy,qualityGateOverrideSupported,,true")
    ...
    void appendsAuditChainPolicyRowsWithoutAuditOrTraceDetails() {
        ...
        org.assertj.core.api.Assertions.assertThat(report)
                ...
                .contains("auditChainPolicy,crossWpAuditDashboardReady,,true,,success")
                .contains("auditChainPolicy,auditOutboxReplayDashboardReady,,true,,success")
