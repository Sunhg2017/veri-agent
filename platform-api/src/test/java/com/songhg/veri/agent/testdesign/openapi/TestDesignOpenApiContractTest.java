...
class TestDesignOpenApiContractTest {
    ...
    void exposesWp5TestDesignContract() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/test-design/tasks/{id}/release-readiness/approvals'].get")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/tasks/{id}/release-readiness/approvals'].post")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/release-readiness/approvals/{id}'].put")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/release-readiness/approvals/{id}/approve'].post")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/release-readiness/approvals/{id}/reject'].post")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/release-readiness/approvals/{id}/notes'].get")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/release-readiness/approvals/{id}/notes'].post")
                        .exists())
                ...
                .andExpect(jsonPath("$.paths['/api/v1/test-design/tasks/{id}/report/archives'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/report-archives/{id}/integrity'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/report-archives/{id}/approvals'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/report-archives/{id}/archive-approvals'].post")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/report-archives/{id}/external-approvals'].post")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/report-archive-approvals/{id}/approve'].post")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/report-archive-approvals/{id}/reject'].post")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/report-archive-approvals/{id}/notes'].get")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/report-archive-approvals/{id}/notes'].post")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/context-policies/projects/{projectId}/effective'].get")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/context-policies/projects/{projectId}/overrides'].get")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/context-policies/projects/{projectId}/overrides'].post")
                        .exists())
                .andExpect(jsonPath(
                        "$.paths['/api/v1/test-design/context-policies/projects/{projectId}/environments/{environmentKey}/overrides'].post"
                ).exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/context-policies/overrides/{id}/approve'].post")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/context-policies/overrides/{id}/reject'].post")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/context-policies/overrides/{id}'].put")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/context-policies/overrides/{id}/notes'].get")
                        .exists())
                .andExpect(jsonPath("$.paths['/api/v1/test-design/context-policies/overrides/{id}/notes'].post")
                        .exists())
