...
class AssetOpenApiContractTest {
    ...
    void exposesWp3AssetContractWithStandardPaths() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/asset/requirements/{id}/versions/{version}/rollback'].post").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/imports'].post").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/exports'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/prototype-sync'].post").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/impact'].get").exists())
                ...
                .andExpect(jsonPath("$.paths['/api/v1/asset/apis/{id}/lifecycle'].patch").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/apis/{id}/versions'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/apis/{id}/versions/{version}/rollback'].post").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/pages'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/pages'].post").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/pages/{id}'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/pages/{id}'].put").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/pages/{id}/lifecycle'].patch").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/pages/{id}/versions'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/pages/{id}/versions/{version}/rollback'].post").exists())
                ...
                .andExpect(jsonPath("$.paths['/api/v1/asset/business-flows/{id}'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/business-flows/{id}'].put").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/business-flows/{id}/lifecycle'].patch").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/business-flows/{id}/versions'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/business-flows/{id}/versions/{version}/rollback'].post").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/test-cases'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/test-cases'].post").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/test-cases/{id}/lifecycle'].patch").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/test-cases/{id}/versions'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/asset/test-cases/{id}/versions/{version}/rollback'].post").exists())
