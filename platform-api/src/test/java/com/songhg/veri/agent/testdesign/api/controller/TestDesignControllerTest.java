...
class TestDesignControllerTest {
    ...
    void exposesHealthWithoutToken() throws Exception {
        mockMvc.perform(get("/api/v1/test-design/health"))
                ...
                .andExpect(jsonPath("$.data.modelObservationPolicy.policyVersion")
                        .value("wp5-model-observation-policy-v1"))
                .andExpect(jsonPath("$.data.modelObservationPolicy.observationMode")
                        .value("ROUTING_COST_LATENCY_AGGREGATE"))
                .andExpect(jsonPath("$.data.modelObservationPolicy.wp2InvocationReferenceTracked").value(true))
                .andExpect(jsonPath("$.data.modelObservationPolicy.traceIdTracked").value(true))
                .andExpect(jsonPath("$.data.modelObservationPolicy.jobIdTracked").value(true))
                .andExpect(jsonPath("$.data.modelObservationPolicy.routingMetadataTracked").value(true))
                .andExpect(jsonPath("$.data.modelObservationPolicy.tokenUsageTracked").value(true))
                .andExpect(jsonPath("$.data.modelObservationPolicy.latencyTracked").value(true))
                .andExpect(jsonPath("$.data.modelObservationPolicy.costTracked").value(true))
                .andExpect(jsonPath("$.data.modelObservationPolicy.fallbackTracked").value(true))
                .andExpect(jsonPath("$.data.modelObservationPolicy.promptPayloadStored").value(false))
                .andExpect(jsonPath("$.data.modelObservationPolicy.payloadPreviewExported").value(false))
                .andExpect(jsonPath("$.data.modelObservationPolicy.traceIdValueExported").value(false))
                .andExpect(jsonPath("$.data.modelObservationPolicy.jobIdValueExported").value(false))
                .andExpect(jsonPath("$.data.modelObservationPolicy.invocationIdValueExported").value(false))
                .andExpect(jsonPath("$.data.modelObservationPolicy.providerErrorTextExported").value(false))
                .andExpect(jsonPath("$.data.modelObservationPolicy.actorServiceExported").value(false))
                .andExpect(jsonPath("$.data.modelObservationPolicy.aggregateOnly").value(true))
    ...
    void storesRedactedContextSummaryAndInputDigest() throws Exception {
        ...
        MvcResult taskResult = mockMvc.perform(post("/api/v1/test-design/tasks")
                ...
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.policyVersion")
                        .value("wp5-model-observation-policy-v1"))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.observationMode")
                        .value("ROUTING_COST_LATENCY_AGGREGATE"))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.wp2InvocationReferenceTracked")
                        .value(true))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.traceIdTracked").value(true))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.jobIdTracked").value(true))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.routingMetadataTracked").value(true))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.tokenUsageTracked").value(true))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.latencyTracked").value(true))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.costTracked").value(true))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.fallbackTracked").value(true))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.promptPayloadStored").value(false))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.payloadPreviewExported").value(false))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.traceIdValueExported").value(false))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.jobIdValueExported").value(false))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.invocationIdValueExported").value(false))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.providerErrorTextExported").value(false))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.actorServiceExported").value(false))
                .andExpect(jsonPath("$.data.task.modelObservationPolicy.aggregateOnly").value(true))
                ...
                .andExpect(jsonPath("$.data.task.contextSummary.auditChainPolicy.publishIdentifierValueExported")
                        .value(false))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.policyVersion")
                        .value("wp5-model-observation-policy-v1"))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.observationMode")
                        .value("ROUTING_COST_LATENCY_AGGREGATE"))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.wp2InvocationReferenceTracked")
                        .value(true))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.promptPayloadStored")
                        .value(false))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.payloadPreviewExported")
                        .value(false))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.traceIdValueExported")
                        .value(false))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.jobIdValueExported")
                        .value(false))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.invocationIdValueExported")
                        .value(false))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.providerErrorTextExported")
                        .value(false))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.actorServiceExported")
                        .value(false))
                .andExpect(jsonPath("$.data.task.contextSummary.modelObservationPolicy.aggregateOnly").value(true))
    ...
    void exportsFullTaskReportWithScopeAndAggregateRedaction() throws Exception {
        ...
        MatcherAssert.assertThat(csv, containsString("modelObservationPolicy,actorServiceExported,,false"));
