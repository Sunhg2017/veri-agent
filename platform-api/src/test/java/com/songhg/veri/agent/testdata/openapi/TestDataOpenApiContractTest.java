...
class TestDataOpenApiContractTest {
    ...
    void documentsTestDataControlPlanePaths() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/test-data/data-sets/{id}/export/download'].get").exists())
                ...
                .andExpect(jsonPath("$.paths['/api/v1/test-data/leases/{id}/export/download'].get").exists())
