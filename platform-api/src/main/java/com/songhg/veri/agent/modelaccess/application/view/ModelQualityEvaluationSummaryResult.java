...
/**
 * Aggregate-safe WP2 quality evaluation summary used by the console and release checks.
 */
public record ModelQualityEvaluationSummaryResult(
        ...
        List<TaskQualityStatsResult> taskStats,
        @Schema(description = "总览统计")
        TaskQualityStatsResult totalStats,
    ...
    public record TaskQualityStatsResult(
